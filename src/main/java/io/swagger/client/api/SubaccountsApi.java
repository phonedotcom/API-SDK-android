...
public class SubaccountsApi {
  ...
  * Get a list of subaccounts for the authenticated user or client
   ...
   * @return ListAccounts
  */
  public ListAccounts listAccountSubaccounts (Integer accountId, List<String> filtersId, String sortId, Integer limit, Integer offset, String fields) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
